...
pdir ='Surface/'
ext='1.png'
help = 'cca runs with cy43h21 MNWC settings and observations. <br> REF: cy43h21 without MSGcloudingest <br> T2H2: REF + T2H2 Upper Air Assimilation'; hide_help = false ;
do_send = true ;
